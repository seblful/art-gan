...
def train(args):
    ...
    collater = train_util.collater_class(
        current_epoch, current_step, ds_for_collater)
    ...
    n_workers = min(args.max_data_loader_n_workers,
                    os.cpu_count() - 1)  # cpu_count-1 ただし最大で指定された数まで
            ...
            for subset in dataset.subsets:
                ...
                if image_dir_or_metadata_file is not None:
                    ...
                    dataset_dirs_info[image_dir_or_metadata_file] = {
                        "n_repeats": subset.num_repeats, "img_count": subset.img_count}
    ...
    minimum_keys = ["ss_network_module", "ss_network_dim",
                    "ss_network_alpha", "ss_network_args"]
    minimum_metadata = {}
    ...
    for epoch in range(num_train_epochs):
        ...
        if args.save_every_n_epochs is not None:
            ...
            def save_func():
                ...
                unwrap_model(network).save_weights(
                    ckpt_file, save_dtype, minimum_metadata if args.no_metadata else metadata)
        ...
        train_util.sample_images(accelerator, args, epoch + 1, global_step,
